...
import { fetchAgent, fetchConversationDetail } from '@/api/agent';
...
const Agents = () => {
  ...
  const loadItems = async () => {
    try {
      ...
      let result: any = await fetchAgent(params);
