...
import groupBg from '@/assets/images/groupBg.png'; // 引入背景图片
...
const GroupList: React.FC<GroupListProps> = ({ onClick, targetId, agentList }) => {
  ...
  return (
    <div className={`${styles.groupList} ${isHovered ? styles.hovered : ''}`}>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            {visibleItems.map((item) => (
              ...
              >
                <img src={item.avatarUrl || groupBg} className={styles.itemBg} />
